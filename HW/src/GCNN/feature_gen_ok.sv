...
module feature_gen_ok #(
    ...
    logic [23 : 0] t_temp;
    logic [15 : 0] f_temp;
    logic f_avg_valid, f_avg_valid_reg, t_avg_valid, t_avg_valid_reg;
    ...
    div_t div_t ( //32 clock latency
        ...
        .m_axis_dout_tvalid     ( t_avg_valid_reg )
    );
    ...
    div_f div_f (//32 clock latency
        ...
        .m_axis_dout_tvalid     ( f_avg_valid_reg )
    );
