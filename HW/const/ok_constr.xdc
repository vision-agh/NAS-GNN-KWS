...
set_clock_groups -asynchronous \
    -group [get_clocks -of_objects [get_pins okHI/okClk]] \
    -group [get_clocks -of_objects [get_pins {clk_wiz_ok_i/clk_out1 clk_wiz_ok_i/clk_out2}]]
...
set_property PACKAGE_PIN W11 [get_ports {clk_200_p}]

set_property IOSTANDARD LVDS_25 [get_ports {clk_200_n}]
set_property PACKAGE_PIN W12 [get_ports {clk_200_n}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-65 
# set_property PACKAGE_PIN J4 [get_ports {i2s_bclk_0}]
# set_property IOSTANDARD LVCMOS33 [get_ports {i2s_bclk_0}]
# # MC2-66 
# set_property PACKAGE_PIN V15 [get_ports {i2s_d_in_0}]
# set_property IOSTANDARD LVCMOS33 [get_ports {i2s_d_in_0}]
# # MC2-67 
# set_property PACKAGE_PIN T16 [get_ports {i2s_lr_0}]
# set_property IOSTANDARD LVCMOS33 [get_ports {i2s_lr_0}]
# MC2-68 
# set_property PACKAGE_PIN T14 [get_ports {reset_0}]
...
# LEDs #####################################################################
#set_property PACKAGE_PIN A13 [get_ports {out_conf[0]}]
#set_property PACKAGE_PIN B13 [get_ports {out_conf[1]}]
#set_property PACKAGE_PIN A14 [get_ports {out_conf[2]}]
#set_property PACKAGE_PIN A15 [get_ports {out_conf[3]}]
#set_property PACKAGE_PIN B15 [get_ports {out_conf[4]}]
#set_property PACKAGE_PIN A16 [get_ports {out_conf[5]}]
#set_property PACKAGE_PIN B16 [get_ports {out_conf[6]}]
#set_property PACKAGE_PIN B17 [get_ports {out_conf[7]}]

#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[0]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[1]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[2]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[3]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[4]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[5]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[6]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {out_conf[7]}]
