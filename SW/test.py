...
def main():
    ...
    # ---- dataset root
    dataset_root = Path("/home/imperator/Dataset/NAS_GSC/vox-praga-mic-pwz-balanced")  # default
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_finetune_praga_mic/CHECKPOINTS/best_model.pth", map_location=device)
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_finetune_praga_mic/CHECKPOINTS/best_model_calibration.pth", map_location=device)
    model.load_state_dict(state, strict=True)
