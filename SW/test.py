...
def main():
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_v3_8cls/CHECKPOINTS/best_model.pth", map_location=device)
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_v3_8cls/CHECKPOINTS/best_model_calibration.pth", map_location=device)
    model.load_state_dict(state, strict=True)
