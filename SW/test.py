...
def main():
    ...
    # ---- dataset root
    dataset_root = Path("/home/imperator/Dataset/NAS_GSC/gsc_v3_32p_ok")  # default
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/CHECKPOINTS/best_model.pth", map_location=device)
    ...
    state = torch.load("/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/CHECKPOINTS/best_model_calibration.pth", map_location=device)
    model.load_state_dict(state, strict=True)
