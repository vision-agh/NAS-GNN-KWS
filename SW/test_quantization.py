...
# Prepare dataset
files = glob.glob(
    f"/home/imperator/Dataset/NAS_GSC/gsc_v3_32p_ok/left/0a2b400e_nohash_0.wav*"
)
# cfg = build_config(model_cfg_path="configs/kws.yaml")

cfg = OmegaConf.load('/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/CHECKPOINTS/config.yaml')
OmegaConf.resolve(cfg)
ds = SpikingDS(files, cfg)

# Prepare model
model = KWS(cfg).to('cuda')
ckpt = torch.load('/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/CHECKPOINTS/best_model_calibration.pth')
...
path_debug = '/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/debug_outputs/'
path_parameters = '/home/imperator/Code/NAS-GNN-KWS/SW/debug_pretrained_gscdv3_new10cls/parameters/'
